<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site.Master" AutoEventWireup="true" CodeBehind="AddPost.aspx.cs" Inherits="DoNgoaiChinhHang.Admin.UI.POST.AddPost" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        ...
        .auto-style4 tr td{border: none}
    </style>
    <script src="../../JS/ProductDetail.js"></script>
    </asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ĐỒ NGOẠI CHÍNH HÃNG/ BÀI VIẾT/ THÊM BÀI VIẾT
</asp:Content>
